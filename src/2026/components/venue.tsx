...
const Venue = () => {
    return (
        ...
        >
            <div className="relative z-0 -mt-2 w-full pb-12 sm:-mt-5 sm:pb-0">
                <img
                    alt="Sea of tickets"
                    src={ticketSea}
                    ...
                    aria-hidden
                />
                <div className="absolute inset-0 z-10 mx-auto grid max-w-[1440px] grid-cols-1 items-start px-6 pt-[32%] sm:items-center sm:pt-[34%] md:grid-cols-2 md:items-start md:px-16 md:pt-[34%] lg:px-24 lg:pt-[36%] xl:pt-[38%] 2xl:pt-[40%]">
            ...
            <div className="mx-auto w-full max-w-[1222px] px-4 pb-8 pt-4 sm:px-6 md:pb-10 md:pt-6 lg:px-10">
                <div className="mx-auto w-full max-w-[min(100%,clamp(18rem,92vw,56rem))] overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-ink/10">
                    <iframe
                        src={VENUE_MAP_EMBED_URL}
                        title="Yashwantrao Chavan Centre on Google Maps"
                        className="h-52 w-full border-0 sm:h-56 md:h-60 lg:h-64"
                        loading="lazy"
