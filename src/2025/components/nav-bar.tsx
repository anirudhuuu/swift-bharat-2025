...
import { Button } from "@/2025/components/ui/button";
    ...
    <nav className="flex w-full px-6 lg:px-18 py-8 items-center justify-between relative">
      ...
      {showNavItems && (
        <>
            ...
            >
              ...
              >
                <line
                  ...
                  stroke="black"
                  strokeWidth="1.5"
                  className={`transition-all duration-300 origin-center ${menuOpen
          ...
          >
            <div
              className={`px-6 py-8 flex justify-between transition-transform duration-300 ease-out ${menuOpen ? "translate-y-0" : "-translate-y-4"
                }`}
            >
              <div className="flex items-center gap-2">
                <img
            ...
            <div
              className={`flex-1 flex flex-col items-center transition-all duration-500 delay-100 ${menuOpen
            ...
            <div
              className={`p-8 w-full flex justify-center transition-all duration-500 delay-200 ${menuOpen
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-4"
                }`}
            >
